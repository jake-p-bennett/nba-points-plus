...
import { getPlayerDetail, getLeaderboard } from "@/lib/data";
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-8">
        ...
        {/* Stats row */}
        <div className="mb-8 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
          ...
          {player.usgPct != null && <StatCard label="USG%" value={`${player.usgPct}%`} />}
          {player.tsPct != null && <StatCard label="TS%" value={`${player.tsPct}%`} />}
        </div>
